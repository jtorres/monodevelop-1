...
namespace Microsoft.TeamFoundation.GitApi
{
    ...
    {
        internal OperationProgress(IOperation operation, OperationProgressType type)
        {
    ...
    /// </summary>
    public delegate bool OperationProgressDelegate(OperationProgress progress);
    ...
    public sealed class CheckingOutFilesProgress : OperationProgress
    {
        ...
        internal CheckingOutFilesProgress(IOperation operation, double completed, long fileCount, long fileTotal)
            : base(operation, OperationProgressType.CheckingOutFiles)
        {
    ...
    public sealed class CompressingObjectsProgress : OperationProgress
    {
        ...
        internal CompressingObjectsProgress(IOperation operation, double completed, long objectCount, long objectTotal)
            : base(operation, OperationProgressType.CompressingObjects)
        {
            Debug.Assert(completed >= 0 && completed <= 1, $"The `{nameof(completed)}` parameter has an unexpected value.");
    ...
    public sealed class CountingObjectsProgress : OperationProgress
    {
        ...
        internal CountingObjectsProgress(IOperation operation, long objectsTotal, long deltasTotal, long objectsReused, long deltaReused)
            : base(operation, OperationProgressType.CountingObjects)
        {
    ...
    public sealed class ReceivingObjectsProgress : OperationProgress
    {
        ...
        internal ReceivingObjectsProgress(IOperation operation, double completed, long objectsRead, long objectsTotal, long readBytes, long readRate)
            : base(operation, OperationProgressType.ReceivingObjects)
        {
            Debug.Assert(completed >= 0 && completed <= 1, $"The `{nameof(completed)}` parameter has an unexpected value.");
    ...
    public sealed class ResolvingDeltasProgress : OperationProgress
    {
        ...
        internal ResolvingDeltasProgress(IOperation operation, double completed, long deltaCount, long deltaTotal)
            : base(operation, OperationProgressType.ResolvingDeltas)
        {
            Debug.Assert(completed >= 0 && completed <= 1, $"The `{nameof(completed)}` parameter has an unexpected value.");
    ...
    public sealed class WritingObjectsProgress : OperationProgress
    {
        ...
        internal WritingObjectsProgress(IOperation operation, double completed, long objectCount, long objectTotal)
            : base(operation, OperationProgressType.WritingObjects)
        {
            Debug.Assert(completed >= 0 && completed <= 1, $"The `{nameof(completed)}` parameter has an unexpected value.");
            Debug.Assert(objectCount >= 0, $"The `{nameof(objectCount)}` parameter is less than zero.");
            Debug.Assert(objectTotal >= 0, $"The `{nameof(objectTotal)}` parameter is less than zero.");
