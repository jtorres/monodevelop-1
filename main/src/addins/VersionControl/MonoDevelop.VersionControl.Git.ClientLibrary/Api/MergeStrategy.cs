...
namespace Microsoft.TeamFoundation.GitApi
{
    ...
    public abstract class MergeStrategy
    {
        ...
        internal abstract void ApplyOptions(Internal.StringBuffer command);
    }
    ...
    public sealed class MergeStrategyResolve : MergeStrategy
    {
        ...
        internal override void ApplyOptions(Internal.StringBuffer command)
        {
        ...
        internal override void ApplyOptions(Internal.StringBuffer command)
        {
            ...
            switch (Renormalize)
            {
                case MergeRecursiveRenormalize.DoRenormalize:
                    command.Append(StrategyOptionPrefix + "renormalize");
                    break;
    ...
    public sealed class MergeStrategyOctopus : MergeStrategy
    {
        ...
        internal override void ApplyOptions(Internal.StringBuffer command)
        {
            command.Append(StrategyPrefix + "octopus");
        }
    }
}
