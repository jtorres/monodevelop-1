...
namespace Microsoft.TeamFoundation.GitApi.Cli
{
    internal class ForEachRefCommand : GitCommand
    {
        ...
        private void ApplyOptions(StringBuffer command, ReferenceOptions options)
        {
            if (command == null)
            ...
            if (options.Excludes != null)
            {
                ...
                command.Append(" --no-merge ")
                       .Append(options.Excludes.RevisionText);
            }
            ...
            if (options.Includes != null)
            {
                ...
                command.Append(" --merge ")
                       .Append(options.Includes.RevisionText);
            }

            if (options.Contains != null)
            {
                command.Append(" --contains ")
                       .Append(options.Contains.RevisionText);
            }
        }
