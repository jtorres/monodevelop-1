...
namespace Microsoft.TeamFoundation.GitApi.Cli
{
    internal class RebaseCommand : GitCommand
    {
        ...
        public RebaseResult AbortRebase(OperationProgressDelegate progressCallback)
        {
            using (var command = new StringBuffer(Command))
            {
        ...
        public RebaseResult ContinueRebase(OperationProgressDelegate progressCallback)
        {
        ...
        public RebaseResult SkipRebase(OperationProgressDelegate progressCallback)
        {
            if (ReferenceEquals(progressCallback, null))
                throw new ArgumentNullException(nameof(progressCallback));
        ...
        private void ApplyOptions(StringBuffer command, RebaseOptions options)
        {
        ...
        private RebaseResult ExecuteRebase(string command, OperationProgressDelegate progressCallback)
        {
