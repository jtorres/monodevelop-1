...
namespace Microsoft.TeamFoundation.GitApi.Internal
{
    ...
    {
        protected OperationParser(IOperation operation)
        {
    ...
    internal class AmbiguousReferenceWarningParser : OperationParser
    {
        ...
        public AmbiguousReferenceWarningParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if ((match = Regex.Match(line)).Success)
            {
                ...
                progress = new AmbiguousReferenceWarningMessage(_operation, referenceName);
                return true;
            }
    ...
    internal sealed class ApplyingMessageParser : OperationParser
    {
        ...
        public ApplyingMessageParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                progress = new ApplyingPatchMessage(_operation, message);
            }
    ...
    internal sealed class RewindingHeadMessageParser : OperationParser
    {
        ...
        public RewindingHeadMessageParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            {
                progress = new RewindingHeadMessage(_operation, line);
            }
    ...
    internal sealed class CheckingOutFilesParser : OperationParser
    {
        ...
        public CheckingOutFilesParser(IOperation operation)
            : base(operation)
        {
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _regex.Match(line)).Success)
                {
                    ...
                    progress = new CheckingOutFilesProgress(_operation, completed, fileCount, fileTotal);
                }
            }
    ...
    internal sealed class CompressingObjectsParser : OperationParser
    {
        ...
        public CompressingObjectsParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _regex.Match(line)).Success)
                {
                    ...
                    progress = new CompressingObjectsProgress(_operation, completed, objectCount, objectTotal);
                }
            }
    ...
    internal sealed class CountingObjectsParser : OperationParser
    {
        ...
        public CountingObjectsParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _regex.Match(line)).Success)
                {
                    ...
                    progress = new CountingObjectsProgress(_operation, objectsTotal, deltasTotal, objectsReused, deltasReused);
                }
            }
    ...
    {
        public HintMessageParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal) )
            {
                ...
                string message = line.Substring(Prefix.Length, line.Length - Prefix.Length)
                                     .TrimEnd();
                progress = new HintOperationMessage(_operation, message);
            }
    ...
    internal sealed class ReceivingObjectsParser : OperationParser
    {
        ...
        public ReceivingObjectsParser(IOperation operation)
            : base(operation)
        {
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _longRegex.Match(line)).Success)
                {
                    ...
                    progress = new ReceivingObjectsProgress(_operation, completed, objectsRead, objectsTotal, readBytes, readRate);
                }
                else if ((match = _shortRegex.Match(line)).Success)
                {
                    ...
                    progress = new ReceivingObjectsProgress(_operation, completed, objectsRead, objectsTotal, 0, 0);
                }
            }
    ...
    internal sealed class RemoteMessageParser : OperationParser
    {
        ...
        public RemoteMessageParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            {
                var message = line.Substring(Prefix.Length);
                progress = new WaitingForRemoteMessage(_operation, message);
            }
    ...
    internal sealed class ResolvingDeltasParser : OperationParser
    {
        ...
        public ResolvingDeltasParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _regex.Match(line)).Success)
                {
                    ...
                    progress = new ResolvingDeltasProgress(_operation, completed, deltaCount, deltaTotal);
                }
            }
    ...
    internal sealed class SubmoduleUpdateModeCompletedParser : OperationParser
    {
        ...
        public SubmoduleUpdateModeCompletedParser(IOperation operation)
            : base(operation)
        {
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            {
                progress = new SubmoduleUpdateCompletedCheckoutProgress(_operation, matchCheckout.Groups[1].Value, matchCheckout.Groups[2].Value);
                return true;
            }
            ...
            {
                progress = new SubmoduleUpdateCompletedMergeProgress(_operation, matchMerge.Groups[1].Value, matchMerge.Groups[2].Value);
                return true;
            }
            ...
            {
                progress = new SubmoduleUpdateCompletedRebaseProgress(_operation, matchRebase.Groups[1].Value, matchRebase.Groups[2].Value);
                return true;
            }
    ...
    internal sealed class SubmoduleUpdateCloningIntoParser : OperationParser
    {
        ...
        public SubmoduleUpdateCloningIntoParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if ((match = _regex.Match(line)).Success)
            {
                progress = new SubmoduleUpdateCloningIntoProgress(_operation, match.Groups[1].Value);
            }
    ...
    internal sealed class SubmoduleUpdateStepDoneParser : OperationParser
    {
        ...
        public SubmoduleUpdateStepDoneParser(IOperation operation)
            : base(operation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                progress = new SubmoduleUpdateStepDoneProgress(_operation);
            }
    ...
    internal sealed class SubmoduleUpdateNotInitializedParser : OperationParser
    {
        ...
        public SubmoduleUpdateNotInitializedParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
    ...
    internal sealed class SubmoduleUpdateRegistrationCompletedParser : OperationParser
    {
        ...
        public SubmoduleUpdateRegistrationCompletedParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (match.Success)
            {
                progress = new SubmoduleUpdateRegistrationCompletedProgress(_operation,
    ...
    internal sealed class SubmoduleUpdateRevisionNotFound : OperationParser
    {
        ...
        public SubmoduleUpdateRevisionNotFound(IOperation operation)
            : base(operation)
        {
    ...
    internal sealed class SubmoduleUpdateUnmergedParser : OperationParser
    {
        ...
        public SubmoduleUpdateUnmergedParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
    ...
    internal sealed class SubmoduleUpdateUnableToCompleteParser : OperationParser
    {
        ...
        public SubmoduleUpdateUnableToCompleteParser(IOperation operation)
            : base(operation)
        {
            _regexCheckout = new Regex(PatternCheckout, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
            _regexMerge = new Regex(PatternMerge, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
    ...
    internal sealed class SubmoduleUpdateUnableToFetchParser : OperationParser
    {
        ...
        public SubmoduleUpdateUnableToFetchParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
    ...
    internal sealed class SubmoduleUpdateUnableToRecurseParser : OperationParser
    {
        ...
        public SubmoduleUpdateUnableToRecurseParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
    ...
    internal sealed class WarningAndErrorParser : OperationParser
    {
        ...
        public WarningAndErrorParser(IOperation opertation)
            : base(opertation)
        { }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(PrefixError, StringComparison.Ordinal))
            {
                ...
                progress = new WarningMessage(_operation, message, OperationErrorType.Error);
            }
            else if (line.StartsWith(PrefixWarning, StringComparison.Ordinal))
            {
                var message = line.Substring(PrefixWarning.Length);
                progress = new WarningMessage(_operation, message, OperationErrorType.Warning);
            }
    ...
    {
        public WarningParser(IOperation opertation)
            : base(opertation)
        { }
    ...
    internal sealed class WritingObjectsParser : OperationParser
    {
        ...
        public WritingObjectsParser(IOperation operation)
            : base(operation)
        {
            _regex = new Regex(Pattern, RegexOptions.Compiled | RegexOptions.CultureInvariant | RegexOptions.Singleline);
        }
        ...
        public override bool TryParse(string line, out OperationProgress progress)
        {
            ...
            if (line.StartsWith(Prefix, StringComparison.Ordinal))
            {
                ...
                if ((match = _regex.Match(line)).Success)
                {
                    ...
                    progress = new WritingObjectsProgress(_operation, completed, objectCount, objectTotal);
                }
            }
