...
namespace Microsoft.TeamFoundation.GitApi.Internal
{
    ...
    internal sealed class DetachedProcess : Base, IProcess
    {
        ...
        internal DetachedProcess(IExecutionContext context, object userData = null)
            : base()
        {
            SetContext(context);
        ...
        /// <summary>
        /// Gets or sets if the filter process is allowed to be elevated or not. The process will
        /// only be elevated if this process is elevated. Non-elevated processes do not spawn
        /// elevated processes.
        /// </summary>
        ...
        /// <summary>
        /// Gets or set the environmental variables which will be passed to the newley created
        /// process when <see cref="Start"/> is called.
        /// </summary>
        ...
        /// </summary>
        public bool RedirectStandardPipes
        {
        ...
        /// <summary>
        /// Gets or sets the working directory for the process to be started. If not set the value
        /// will default to <see cref="Environment.WorkingDirectory"/>.
        /// </summary>
        /// <exception cref="InvalidOperationException">After <see cref="Start"/> has been called.</exception>
        /// <exception cref="ArgumentNullException">When the value set is null or white-space.</exception>
        /// <exception cref="DirectoryNotFoundException">When the value set is not a valid and
        /// accessible directory.</exception>
        ...
        private bool _createStandardPipes;
        ...
        public Task<bool> Exit(TimeSpan timeout)
        {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        string applicationName = (CreateApplicationNameCallback == null)
                                               ? null
                                               : CreateApplicationNameCallback(_environment);
                        ...
                        string commandLine = _createProcessCommandLineCallback(_command, _environment);
                        ...
                        (_environment ?? Context.EnvironmentCreate()).GetEnvironmentBlock(ref envChars);
                        ...
                        if (_allowElevated)
                        {
                            ...
                            if (!Win32.Kernel32.CreateProcess(applicationName: applicationName,
                                                              ...
                                                              currentDirectory: _workingDirectory,
                    ...
                    if (!_redirectStandardPipes && _createStandardPipes)
                    {
                        ...
                        var timeout = Task.Run(() =>
                        {
                            ...
                            // manifest pipe names.
                            var env = _environment as GitProcessEnvironment;
                            if (env == null)
                                return false;
        ...
        internal static Encoding GetEncoding(uint codepage)
        {
            ...
            if (defaultEncCodePage == codepage || defaultEncCodePage != Encoding.UTF8.CodePage)
            {
                ...
                { /* if it is not supported, bummer - move on */ }
            }
        ...
        private void CreatePipe(out SafeFileHandle localHandle, out SafeFileHandle childHandle, PipeKind pipeKind)
        {
            ...
            if (_environment is GitProcessEnvironment)
            {
                pipeName = (_environment as GitProcessEnvironment).GetPipeName(pipeKind);
            }
            else
            {
