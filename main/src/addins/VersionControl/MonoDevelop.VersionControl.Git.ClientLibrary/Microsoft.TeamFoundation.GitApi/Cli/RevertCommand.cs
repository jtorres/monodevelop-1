...
namespace Microsoft.TeamFoundation.GitApi.Cli
{
    ...
    internal class RevertCommand : GitCommand
    {
        ...
        /// <para>https://www.kernel.org/pub/software/scm/git/docs/git-revert.html</para>
        /// </summary>
        public RevertResult Abort(OperationCallback progressCallback)
        {
        ...
        /// <para>https://www.kernel.org/pub/software/scm/git/docs/git-revert.html</para>
        /// </summary>
        public RevertResult Continue(OperationCallback progressCallback)
        {
            if (ReferenceEquals(progressCallback, null))
                throw new ArgumentNullException(nameof(progressCallback));
        ...
        /// </summary>
        private RevertResult ExecuteRevert(string command, OperationCallback progressCallback)
        {
