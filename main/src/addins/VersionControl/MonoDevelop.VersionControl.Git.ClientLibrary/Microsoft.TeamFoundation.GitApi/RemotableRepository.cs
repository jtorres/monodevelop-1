...
namespace Microsoft.TeamFoundation.GitApi
{
    public sealed class RemotableRepository : Base, IEquatable<RemotableRepository>, IRepository, IStringCache
    {
        ...
        public void CreateBranch(string branchName, IBranch upstream)
        {
            ExecuteTaskSynchronously(() => RepositoryService.CreateBranchAsync(this.SharedWorkingDirectoryInternal, branchName, upstream, CancellationToken.None));
        }
        ...
        {
            return RepositoryService.GetAllTagsAsync(this.SharedWorkingDirectoryInternal);
        }
        ...
        {
            return ExecuteTaskSynchronously(() => RepositoryService.ReadConfigAsync(this.SharedWorkingDirectoryInternal, CancellationToken.None));
        }

        static IReadOnlyList<ConfigurationEntry> ReadGlobalConfigList(IExecutionContext context, object userData)
        {
        ...
        public RebaseResult RebaseAbort(OperationCallback progressCallback)
        {
        ...
        public RebaseResult RebaseContinue(OperationCallback progressCallback)
        {
        ...
        public RebaseResult RebaseSkip(OperationCallback progressCallback)
        {
        ...
        public void ResetHard(IRevision revision, OperationCallback progressCallback)
        {
        ...
        public RevertResult RevertAbort(OperationCallback progressCallback)
        {
        ...
        public RevertResult RevertContinue(OperationCallback progressCallback)
        {
        ...
        public Blame GetBlame (BlameOptions options)
        {
            return ExecuteTaskSynchronously (() => RepositoryService.GetBlameAsync (this.SharedWorkingDirectoryInternal, options, CancellationToken.None));
        }
    ...
    public interface IRepositoryService
    {
        ...
        Task CreateBranchAsync(string repositoryPath, string branchName, IBranch upstream, CancellationToken cancellationToken);
        ...
        Task<ITagName[]> GetAllTagsAsync(string repositoryPath);
        ...
        Task<Configuration> ReadConfigAsync(string repositoryPath, CancellationToken cancellationToken);
        ...
        Task<RebaseResult> RebaseAbortAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken);
        ...
        // TODO: Can't have this type of callback
        Task<RebaseResult> RebaseContinueAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken);
        // TODO: Can't have this type of callback
        Task<RebaseResult> RebaseSkipAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken);
        ...
        // TODO: Can't have this type of callback
        Task ResetHardAsync(string repositoryPath, IRevision revision, OperationCallback progressCallback, CancellationToken cancellationToken);
        ...
        // TODO: Can't have this type of callback
        Task<RevertResult> RevertAbortAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken);
        // TODO: Can't have this type of callback
        Task<RevertResult> RevertContinueAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken);
        ...
        Task<Blame> GetBlameAsync (string repositoryPath, BlameOptions options, CancellationToken cancellationToken);
    }
    ...
    public sealed class RepositoryService : IRepositoryService
    {
        ...
        public Task CreateBranchAsync(string repositoryPath, string branchName, IBranch upstream, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
            repository.CreateBranch(branchName, upstream);
            return Task.CompletedTask;
        }
        ...
        public Task<ITagName[]> GetAllTagsAsync(string repositoryPath)
        {
            var repository = GetRepository(repositoryPath);
            return repository.GetAllTagsAsync();
        }
        ...
        public Task<Configuration> ReadConfigAsync(string repositoryPath, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
            var result = repository.ReadConfig();
            return Task.FromResult(result);
        }
        ...
        public Task<RebaseResult> RebaseAbortAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task<RebaseResult> RebaseContinueAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task<RebaseResult> RebaseSkipAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task ResetHardAsync(string repositoryPath, IRevision revision, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task<RevertResult> RevertAbortAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task<RevertResult> RevertContinueAsync(string repositoryPath, OperationCallback progressCallback, CancellationToken cancellationToken)
        {
            var repository = GetRepository(repositoryPath);
        ...
        public Task<Blame> GetBlameAsync (string repositoryPath, BlameOptions options, CancellationToken cancellationToken)
        {
            var repository = GetRepository (repositoryPath);
            var result = repository.GetBlame (options);
            return Task.FromResult (result);
        }
    }
}