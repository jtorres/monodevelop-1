...
namespace Microsoft.TeamFoundation.GitApi
{
    ...
    {
        internal SubmoduleUpdateCompletedProgress(OperationProgressType type,
    ...
    public sealed class SubmoduleUpdateCompletedCheckoutProgress : SubmoduleUpdateCompletedProgress
    {
        ...
        internal SubmoduleUpdateCompletedCheckoutProgress(string subPath, string sha)
            : base(OperationProgressType.SubmoduleUpdateCheckoutCompleted, LabelCheckout, subPath, sha)
        { }
    }
    ...
    public sealed class SubmoduleUpdateCompletedMergeProgress : SubmoduleUpdateCompletedProgress
    {
        ...
        internal SubmoduleUpdateCompletedMergeProgress(string subPath, string sha)
            : base(OperationProgressType.SubmoduleUpdateMergeCompleted, LabelMerge, subPath, sha)
        { }
    }
    ...
    public sealed class SubmoduleUpdateCompletedRebaseProgress : SubmoduleUpdateCompletedProgress
    {
        ...
        internal SubmoduleUpdateCompletedRebaseProgress(string subPath, string sha)
            : base(OperationProgressType.SubmoduleUpdateRebaseCompleted, LabelRebase, subPath, sha)
        { }
    }
    ...
    {
        internal SubmoduleUpdatePathProgress(OperationProgressType type,
    ...
    public sealed class SubmoduleUpdateCloningIntoProgress : SubmoduleUpdatePathProgress
    {
        ...
        internal SubmoduleUpdateCloningIntoProgress(string absPath)
            : base(OperationProgressType.SubmoduleUpdateCloningInto, LabelClone, absPath)
        { }
    }
    #endregion
    ...
    public sealed class SubmoduleUpdateStepDoneProgress : OperationProgress
    {
        ...
        internal SubmoduleUpdateStepDoneProgress()
            : base(OperationProgressType.SubmoduleUpdateStepDone)
        { }
    }
    ...
    public sealed class SubmoduleUpdateRegistrationCompletedProgress : OperationProgress
    {
        ...
        internal SubmoduleUpdateRegistrationCompletedProgress(string subName, string subUrl, string subPath)
            : base(OperationProgressType.SubmoduleUpdateRegistrationCompleted)
        {
