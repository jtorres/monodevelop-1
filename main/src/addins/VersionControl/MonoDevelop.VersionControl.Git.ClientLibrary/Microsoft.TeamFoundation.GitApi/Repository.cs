...
namespace Microsoft.TeamFoundation.GitApi
{
    public interface IRepository : IDisposable, IEquatable<IRepository>
    {
        ...
        /// <para>https://www.kernel.org/pub/software/scm/git/docs/git-branch.html</para>
        /// </summary>
        void CreateBranch(string branchName, IBranch trackedBranch);
        ...
        /// <summary>
        /// Read the config for the repository.
        /// </summary>
        ...
        RebaseResult RebaseAbort(OperationCallback progressCallback);

        RebaseResult RebaseBegin(IRevision upstream, RebaseOptions options);

        RebaseResult RebaseContinue(OperationCallback progressCallback);

        RebaseResult RebaseSkip(OperationCallback progressCallback);
        ...
        void ResetHard(IRevision revision, OperationCallback progressCallback);
        ...
        /// <para>https://www.kernel.org/pub/software/scm/git/docs/git-revert.html</para>
        /// </summary>
        RevertResult RevertAbort(OperationCallback progressCallback);

        /// <summary>
        /// <para>Continue the revert a commit.</para>
        /// <para>https://www.kernel.org/pub/software/scm/git/docs/git-revert.html</para>
        /// </summary>
        RevertResult RevertContinue(OperationCallback progressCallback);
        ...
        Blame GetBlame (BlameOptions options);
    }
    ...
    public sealed class Repository : Base, IEquatable<Repository>, IRepository, IStringCache
    {
        ...
        /// <param name="options">Options for customizing the clone operation.</param>
        /// <param name="userData">Optional data attached to any trace messages sent from this command to listeners.</param>
        public static async Task<IRepository> CloneAsync (IExecutionContext context, string remoteUrl, string workingDirectory, CloneOptions options, object userData, CancellationToken cancellationToken = default)
        {
            Environment environment = context.Git.GetProcessEnvironment (workingDirectory,
                                                                        ignorePathCasing: false);
            ...
            await new Cli.CloneCommand (executionContext, environment, userData).NormalFromRemoteAsync (remoteUrl, workingDirectory, options, cancellationToken);
        ...
        {
            new Cli.BranchCommand(Context, this).Create(branchName, upstream);
        }
        ...
        {
            return new Cli.TagCommand(Context, this).GetAllTagsAsync ();
        }
        ...
        {
            return new Cli.ConfigCommand(Context, this).ReadConfigList();
        }

        public Configuration ReadConfig()
        {
            return new Cli.ConfigCommand(Context, this).ReadConfig();
        }
        ...
        public static IReadOnlyList<ConfigurationEntry> ReadGlobalConfigList(IExecutionContext context, object userData)
        {
            ...
            return new Cli.ConfigCommand(executionContext, environment, userData).ReadConfigList();
        }
        ...
        {
            return new Cli.BlameCommand (Context, this).ReadBlame (options);
        }
